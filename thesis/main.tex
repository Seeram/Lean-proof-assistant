...
\end{align*}
    %Premenovaním nazývame nahradenie voľných premenných vo výraze.
    %\begin{equation*}
        %t \{ y / x \}
    %\end{equation*}
    %Kde vo výraze $t$ je premenovaná premenná $x$ za $y$.
    ...
    \begin{theorem}
        ...
        \end{equation}
    \end{theorem}
    %Nahradenie je silnejšie ako premenovanie pretože dokáže nahradiť aj premmenné
%viazanné abstrakciou.
    %Tento rozdiel prezentujeme aj na nasledujúcom príklade:
    %\begin{align*}
...
typ pomocou pravidiel $(\overset{I}{\rightarrow})$, $(\overset{E}{\rightarrow})$ a $(ax)$. Ak d
...
V nasledujúcom úseku si ukážeme vetu o izomorfizme pre modulárne zväzy. a podrobne si rozoberieme implementáciu jej dôkazu s obsahom prostredia v Leane.
