...
v duchu učenia Brouwera(1881-1966) a Heytinga(1898-1980) \cite{constructivism}.
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{prooftree}
        ...
        \infer1[$(\implies_{I})$]{\Gamma \vdash A \implies B}
    \end{prooftree}
\end{minipage}
\vskip 0.2in
\begin{minipage}[t]{0.48\textwidth}
    \begin{prooftree}
        \hypo{\Gamma \vdash A \wedge B}
...
\begin{center}
    \begin{prooftree}
        \hypo{}
        \infer1[$(ax)$]{\Gamma, A, B \vdash A}
        \infer1[$(\implies_{I})$]{\Gamma, A \vdash B \implies A}
        \infer1[$(\implies_{I})$]{\Gamma \vdash A \implies ( B \implies A ) }
    \end{prooftree}
\end{center}
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{prooftree}
        \hypo{\Gamma , x : A \vdash t : B }
        \infer1[$(\overset{I}{\rightarrow})$]{\Gamma \vdash \lambda x.t : A \to B}
    \end{prooftree}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
...
\begin{center}
    \begin{prooftree}
        \hypo{\Gamma, x : A, y : B \vdash t : A}
        \infer1[$(\overset{I}{\rightarrow})$]{\Gamma x : A \vdash \lambda y.t : B \to A}
        \infer1[$(\overset{I}{\rightarrow})$]{\Gamma \vdash \lambda x . \lambda y.t: A \to (B \to A )}
    \end{prooftree}
\end{center}
...
typ pomocou pravidiel $(\overset{I}{\rightarrow})$, $(\overset{E}{\rightarrow})$ a $(ax)$.
    ...
    Nasledujúci formálny dôkaz je prevzatý z publikácie \cite{SorensenUrzyczyn}.
...
\begin{enumerate}
    \item Derivácia je
        ...
        \end{center}
        Berieme do úvahy prípady
        \begin{enumerate}
            \item $\varphi \in \Gamma$. Potom $\Delta \vdash x_{\varphi} : \varphi$.
            \item $\varphi \notin \Gamma$. Potom $\Delta, x_{\varphi} : \varphi \vdash x_{\varphi} : \varphi$.
        \end{enumerate}
    \item Derivácia končí v prípade
    \begin{center}
        \begin{prooftree}
        ...
        \end{prooftree}
    \end{center}
    Indukčným predpokladom $\Gamma \vdash M : \varphi \to \psi$ a $\Gamma \vdash N : \varphi$ tak
    potom aj $\Gamma \vdash M N : \psi$.
    \item Derivácia končí v prípade
    \begin{center}
        \begin{prooftree}
        ...
        \end{prooftree}
    \end{center}
    Berieme do úvahy 2 prípady
    \begin{enumerate}
        \item $\varphi \in \Gamma$. Potom podľa indukčného predpokladu $\Delta \vdash M : \varphi$.
            Uvedením do kontextu, $\Delta, x : \varphi \vdash M : \varphi$ kde $x \notin domain(\Delta)$.
            Tak potom taktiez $\Delta \vdash \lambda x : \varphi$. $ M : \varphi \to \psi$.
        \item $\varphi \notin \Gamma$. Potom podľa indukčného predpokladu $\Delta, x_{\varphi} : \varphi \vdash M : \psi$
            tak potom aj $\Delta \vdash \lambda x_{\varphi} : \varphi$. $M :  \varphi \to \psi$.
    \end{enumerate}
\end{enumerate}
\qed
...
si rozoberieme implementáciu jej dôkazu s obsahom prostredia v Leane.
    Dôkaz aj z je prevzatý z publikácie \cite{gratzer}
...
Lean-u a prirodzenú dedukciu pomocou ktorej tvoríme dôkazy.
    ...
    Predstavili sme Lean ako jeden z asistentov dokazovania pomocou ktorého
dokážeme vytvárať formálne dôkazy.
...
móde dokázali vetu o izomorfizme modulárnych zväzov.
    Podrobne opísali príspevok do projektu mathlib ktorého tvorila
...
\begin{thebibliography}{xx}
    ...
    \bibitem{programming_languages} Types and Programming Languages, ISBN 0-262-16209-1, Benjamin C. Pierce publikované v 2002
    \bibitem{gratzer} Lattice Theory: Foundation, 978-3-0348-0018-1, George Grätzer, 2011
    \bibitem{constructivism} Constructivism in Mathematics, Vol 1, Volume 121 1st Edition, A.S. Troelstra D. van Dalen, eBook ISBN 978-0-0805-7088-, publikované v 1988
